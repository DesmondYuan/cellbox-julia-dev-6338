...
# sbatch cellbox-julia-dev-6338/final_train5_o2_TaskA/net5_50.jl
# Task A - Part II - 48 * 20 min
# sbatch cellbox-julia-dev-6338/final_train5_o2_TaskA/net10_20.jl
# Task A - Part III - 24 * 40 min
# sbatch cellbox-julia-dev-6338/final_train5_o2_TaskA/net100.jl

# Task B - Part I - 96 * 10 min
# sbatch cellbox-julia-dev-6338/final_train5_o2_TaskB/ts1_40.jl
